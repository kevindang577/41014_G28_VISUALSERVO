...
hFigure = figure('Name', 'Visual Servoing with Webcam', 'NumberTitle', 'off', 'MenuBar', 'none');
...
% Callback functions remain the same as in your original code
...
function btnSimulationCallback(~, ~)
    ...
    ur3Robot.model.plot(zeros(1, 6), 'workspace', [-2 2 -2 2 0 2]);
